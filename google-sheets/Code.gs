...
function crearEstructura() {
  ...
  var hojas = [
    ...
    },
    {
      ...
      cabeceras: ['ID_Odoo', 'Numero', 'Cliente_Nombre', 'Referencia_Cliente', 'Fecha', 'Moneda', 'Importe', 'Condiciones_Pago', 'Ultima_Actualizacion', 'Total_Cobrado', 'Facturas_Ref', 'Hilldun_Decision'],
      anchos: [180, 100, 200, 160, 100, 60, 100, 120, 140, 110, 200, 120]
    },
    {
      nombre: SHEET_NAMES.FACTURAS,
      cabeceras: ['ID_Odoo', 'Numero', 'Cliente_Nombre', 'Pedidos_Ref', 'Fecha', 'Vencimiento', 'Moneda', 'Importe', 'Es_Abono', 'Facturas_Abonadas', 'Notas', 'Tracking_DHL', 'Tracking_Seguimiento', 'Tracking_Envio', 'Modo_Pago', 'Hilldun_Enviada', 'Ultima_Actualizacion'],
      anchos: [180, 120, 200, 120, 100, 100, 60, 100, 70, 150, 200, 150, 150, 150, 120, 120, 140]
    },
    {
